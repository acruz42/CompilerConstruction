/*  Symbol Table --linked list  headers
    ...
    Modified Spring 2015 to allow for name to pointed to by symtable,
    instead of copied, since the name is copied into the heap
...
function prototypes and structure declaration for SymbTab
...
struct SymbTab
{
   ...
   enum SYSTYPE Type;  /* the type of the symbol */
